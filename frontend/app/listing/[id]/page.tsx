    ...
    <main className="min-h-screen overflow-x-hidden">
      <div className="relative overflow-x-hidden px-3 py-4 sm:px-4">
            ...
            <div className="glass-card p-8 max-w-sm w-full text-center space-y-5">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-silver">
                  The listing has been cancelled on-chain and removed.
                </p>
              </div>
              {cancelTxHash && (
                <a
            ...
            <div className="glass-card p-6 w-full max-w-sm space-y-4">
              ...
              {canForceCancel && (
                <p className="text-xs text-silver/70 border border-white/10 bg-white/5 px-3 py-2">
                  The on-chain transaction did not go through. You can try again or remove the
                  listing from your account without a blockchain transaction.
                </p>
              )}
            ...
            <div className="mx-auto flex h-full w-full max-w-6xl flex-col rounded-glass border border-white/10 bg-[#07152a]/95 shadow-2xl">
              <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                ...
                <button
                  ...
                  className="rounded-glass border border-white/20 px-3 py-1 text-xs font-medium text-silver hover:text-white hover:bg-white/10"
                >
                  Close
                </button>
              </div>
        ...
        {priceUpdateFailedBanner && (
          <div className="mb-4 rounded-glass border border-amber-500/50 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
            {priceUpdateFailedBanner}
          </div>
        )}
          ...
          <div className="min-w-0 space-y-4">
            ...
            {listing &&
              ...
              listing.buyer.toLowerCase() === address.toLowerCase() && (
                <div className="glass-card p-4 rounded-glass border border-emerald-500/30 bg-emerald-500/5">
            ...
            {listing &&
              ...
              Number(onChainListing.status) === 0 &&
              listing.status === "LISTED" && (
                <div className="rounded-glass border border-amber-500/40 bg-amber-500/10 p-4 space-y-2">
            ...
            <div className="border-t border-white/10 pt-4">
              ...
              {isSeller &&
                (walletConnected ? (
                  <Link
                    href={`/create?duplicate=${encodeListingIdForUrl(id)}`}
                    className="btn-frost-cta w-full mt-2 inline-block text-center border-white/20"
                  >
                    Duplicate listing
                  </Link>
                ) : (
                  <div className="rounded-glass border border-white/20 bg-white/5 px-4 py-3 text-center text-silver text-sm mt-2">
            ...
            <div className="mt-8 glass-card p-6">
                ...
                <div className="space-y-3 mb-4 max-h-80 overflow-y-auto">
                  {chatMessages.map((msg) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`max-w-xs lg:max-w-md rounded-glass px-3 py-2 text-sm ${
                            isMe
              ...
              <div className="flex gap-2 mt-4">
                <input
                  ...
                  className="flex-1 bg-white/5 border border-white/20 rounded-glass px-3 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#00ffa3]/40"
                />
                <button
                  type="button"
                  onClick={() => void sendChatReply()}
                  disabled={chatSending || !chatReply.trim()}
                  className="px-4 py-2 bg-white/10 border border-white/20 text-white text-sm font-medium rounded-glass hover:bg-white/20 transition-colors disabled:opacity-40"
                >
                  {chatSending ? "…" : "Send"}
                </button>
              </div>
